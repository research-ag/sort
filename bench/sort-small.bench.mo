  ...
  public func init() : Bench.Bench {
    ...
    bench.runner(
      func(row, col) {
        if (col == "8") {
          if (row == "insertion") {
            for (i in Nat32.range(0, 1000)) insertionSortSmall(a, a, func i = i, i * 8, 8 : Nat32);
          } else {
            for (i in Nat.range(0, 1000)) batcherSortSmall(b, b, func i = i, i * 8, 8);
          };
        } else if (col == "worst") {
          if (row == "insertion") {
            for (i in Nat32.range(0, 1000)) insertionSortSmall(worst, worst, func i = i, i * 8, 8 : Nat32);
          } else {
            for (i in Nat.range(0, 1000)) batcherSortSmall(worstClone, worstClone, func i = i, i * 8, 8);
          };
        } else {
          if (row == "insertion") {
            for (i in Nat32.range(0, 1000)) insertionSortSmall(best, best, func i = i, i * 8, 8 : Nat32);
          } else {
